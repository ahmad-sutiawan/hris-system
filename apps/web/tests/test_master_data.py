...
class MasterDataTests(TestCase):
    ...
    def test_master_sidebar_flat_submenu(self):
        ...
        self.assertEqual(content.count("Data Master"), 1)
        self.assertIn("Organisasi", content)
        self.assertIn("Jabatan", content)
        self.assertIn("Plant", content)
        self.assertIn("Cabang", content)
        ...
        self.assertIn("Ringkasan Absensi", content)
