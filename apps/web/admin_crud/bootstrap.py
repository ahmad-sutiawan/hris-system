...
def bootstrap_registry():
    ...
    register(
        AdminResource(
            ...
            section="Penggajian",
            title="Pemetaan PTKP → TER",
            title_plural="Pemetaan PTKP → TER",
            columns=[
    ...
    register(
        AdminResource(
            ...
            columns=[
                ...
                Column("Name", "name"),
                Column("Label", "label"),
                Column("Check-in", "scheduled_check_in"),
                Column("Check-out", "scheduled_check_out"),
                Column("Break (min)", "break_minutes"),
                Column("Grace (min)", "grace_period_minutes"),
                Column("Working hrs", "schedule_working_hours"),
                Column("Cross-day", "cross_day"),
                Column("Allowance code", "shift_allowance_code"),
                Column("Active", "is_active"),
            ],
    ...
    register(
        AdminResource(
            ...
            title_plural="Proses Penggajian",
            columns=[
                Column("Plant", "plant"),
    ...
    register(
        AdminResource(
            ...
            section="Karyawan",
            title="Referensi Talenta",
            title_plural="Referensi Talenta",
            columns=[
