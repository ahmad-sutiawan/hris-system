...
urlpatterns = [
    ...
    path("payroll/compensation/", views.employee_compensation_list, name="employee_compensation_list"),
    path(
        "payroll/compensation/<int:pk>/edit/",
        views.employee_compensation_edit,
        name="employee_compensation_edit",
    ),
    ...
    path("attendance/<int:pk>/correct/", views.attendance_correct, name="attendance_correct"),
...
if getattr(settings, "HRIS_ENABLE_ADMIN_CONSOLE", False):
    urlpatterns += [
